...
# ╔═╡ c660a4d1-dd70-4196-abb7-ec73e870e7ae
datadir = joinpath("..", "..", "data", "PacBio_VSG")
...
begin
	filtered_reads = Vector{FASTARecord}();
   	FASTAReader( open(joinpath(datadir , "filtered_reads", "PacBio_VSG_filtered_reads_" * sample[1] * ".fasta"))) do reader
...
begin
	df = DataFrame(CSV.File( joinpath(datadir, "blastn", "PacBio_VSG_filtered_reads_blastn_" * sample[1] * ".txt"), header=false ));
...
begin
	predicted_orfs = Vector{FASTARecord}();
	   FASTAReader( open(joinpath(datadir, "orf", "PacBio_VSG_filtered_reads_ORF_" * sample[1] * ".fasta")) ) do reader
	      for record in reader
...
manifest_format = "2.0"
project_hash = "1f8bf9dd52d00e1e6d5d1c547eb2128838b13b0b"
...
git-tree-sha1 = "3997810d996142e62aa426deed5bd858339e2332"
uuid = "7e6ae17a-c86d-528c-b3b9-7f778a29fe59"
version = "3.5.0"

[[deps.BioSymbols]]
deps = ["PrecompileTools"]
git-tree-sha1 = "41e42d326ff01d12167f3f8a218b318bf7429d0f"
...
git-tree-sha1 = "cfbc767762419cc2b6b61a2c70aa81e54b27000f"
