...
datadir = joinpath("..", "..", "data", "Coronavirus")
...
begin
	protein_N_data = Vector{FASTARecord}();
   	FASTAReader( open(joinpath(datadir,"protein_N_data.fasta")) ) do reader
...
begin
	pl = plot(hc,permute=:horizontal, xlims=[0, 4])
...
begin
	df = DataFrame(CSV.File(joinpath(datadir,"motifCountMatrix.csv")))
...
genome = first( FASTAReader( open(joinpath(datadir,"GCA_011537005.1_partial_genomic.fasta")) ) )
...
manifest_format = "2.0"
project_hash = "b59b3bade66c1b9529901c80ea1f7a4082eb602a"
...
git-tree-sha1 = "6a0c6a01af5bfdbbcb7679c51026da0fc7304d6e"
